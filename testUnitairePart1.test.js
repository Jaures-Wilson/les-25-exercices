...
describe("the function return an array with classed values", () => {
    test("the function should be return an array", () => {
        expect(combinedArr([1,2,3],[1,2,3,4,5])).toStrictEqual([ 1, 2, 3, 4, 5 ]);
    });
    test("the function should be return an array", () => {
        expect(combinedArr([984,54,684,6841,35,84],[651,98,65,684,5.1,91,3541,651,99])).toStrictEqual([5.1,  35,  54,   65,   84, 91,  98,  99,  651, 684, 984, 3541, 6841]);
    });
}); 
...
describe("the function delete a property of object", () =>{ 
    test('the function should return an object', () => {
        expect(destructionOnCar()).toStrictEqual([ 'Cameroun', 'toyota', '2012' ]);
    }); 
})
...
describe("the function return the average of all the value", () =>{ 
    test('the function should return a value', () => {
        expect(displayBooksWithMoreThan300Pages([{title:'val', pages:51},{title:'val1' , pages:500},{title:'val2' , pages:200},{title:'val3' , pages:651}, {title:'val4' , pages:0},
            {title:'val5' , pages:651},{title:'val6' , pages:499}])).toStrictEqual([{ title: 'val1', pages: 500 },{ title: 'val3', pages: 651 },{ title: 'val5', pages: 651 },{ title: 'val6', pages: 499 }]);
    }); 
})
